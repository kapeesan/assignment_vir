...
import com.example.SpringWork.exception.RecordException;
...
public class DocumentServiceImpl implements DocumentService {
	...
	public void validateRecord(Integer id) {
        if (!idPresent(id)) {
            throw new RecordException("Record don't exits");
        }
    }

    private boolean idPresent(Integer id) {
	...
	@Override
	public Card fetchCard(Integer id) {
		// TODO Auto-generated method stub
